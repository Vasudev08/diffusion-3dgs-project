...
class AgenticPipeline:
    ...
    def _initialize_models(self):
        ...
        try:
            ...
            if self.config.verbose:
                print(f"Warning: Could not initialize Stable Virtual Camera: {e}")

        # Register Real-ESRGAN model
        try:
            ...
            if self.config.verbose:
                print(f"Warning: Could not initialize Real-ESRGAN: {e}")
    ...
    def process(
        ...
        input_copy = temp_dir / "input_image.jpg"
        ...
        try:
            ...
            plan_result = self.agent.plan_processing(input_copy, temp_dir)
